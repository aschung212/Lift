          ...
          <div class="settingsSheet" :ref="onSettingsSheetMounted" :style="settingsSwipe.dragStyle()" role="dialog" aria-modal="true" aria-labelledby="settings-title">
            ...
            <div class="settingsGroup">
              ...
              <div class="settingsRow">
                ...
                <button
                  :class="['glassToggle', { on: prefs.experience.wakeLock }]"
                  @click="toggleExperience('wakeLock')"
                  role="switch"
                  :aria-checked="prefs.experience.wakeLock"
                  :aria-label="prefs.experience.wakeLock ? 'Disable screen wake lock' : 'Enable screen wake lock'"
                >
                  <span class="glassToggleThumb"></span>
                </button>
              </div>
...
function toggleExperience(key: 'prCelebrations' | 'haptics' | 'wakeLock') {
