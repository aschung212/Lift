              ...
              <div class="settingsThemeGrid">
                ...
                >
                  ...
                  >
                    ...
                    <svg v-else-if="t.icon === 'earth'" viewBox="0 0 24 24" fill="currentColor" width="20" height="20"><path d="M17 8C8 10 7 18 7 18s4-1 7-3c3-2 5-5 5-5l-2-2z"/><path d="M7 18c0 0-1-4 2-7" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M5 20c0 0 1-2 2-2" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>
