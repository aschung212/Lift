            ...
            <div class="settingsGroup">
              ...
              <div v-if="useCollapsedPicker && !themeGridExpanded" class="settingsRow">
                ...
                <button class="themeCollapsedBtn" @click="themeGridExpanded = true" aria-label="Change theme">
                  ...
                  >
                    <svg v-if="currentTheme === 'fire'" viewBox="0 0 24 24" fill="currentColor" width="18" height="18"><path d="M12 23c-4.97 0-8-3.03-8-7 0-2.5 1.5-5 3-6.5.5-.5 1.37-.18 1.37.54 0 1.3.6 2.46 1.63 3.2.2.14.46-.05.38-.28-.5-1.46-.63-3.1-.08-4.96C11.5 4.5 14 2 16 1c.4-.2.82.18.68.6C15.5 5.5 17 7 18 8.5c2 3 2 5 2 6.5 0 3.97-3.03 8-8 8z"/></svg>
                    <svg v-else-if="currentTheme === 'water'" viewBox="0 0 24 24" fill="currentColor" width="18" height="18"><path d="M2 15c0 0 2-3 4-3s4 3 6 3 4-3 6-3 4 3 4 3M2 19c0 0 2-3 4-3s4 3 6 3 4-3 6-3 4 3 4 3M2 11c0 0 2-3 4-3s4 3 6 3 4-3 6-3 4 3 4 3" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>
                    <svg v-else-if="currentTheme === 'luck'" viewBox="0 0 24 24" fill="currentColor" width="18" height="18"><path d="M12 12C12 12 8 9 8 6.5C8 4.5 9.5 3 11 3c.6 0 1 .3 1 .3s.4-.3 1-.3c1.5 0 3 1.5 3 3.5C16 9 12 12 12 12z"/><path d="M12 12C12 12 15 8 17.5 8C19.5 8 21 9.5 21 11c0 .6-.3 1-.3 1s.3.4.3 1c0 1.5-1.5 3-3.5 3C15 16 12 12 12 12z"/><path d="M12 12C12 12 8 15 5.5 15C3.5 15 2 13.5 2 12c0-.6.3-1 .3-1S2 10.6 2 10c0-1.5 1.5-3 3.5-3C8 7 12 12 12 12z" opacity="0.85"/><path d="M12 12C12 12 16 15 16 17.5C16 19.5 14.5 21 13 21c-.6 0-1-.3-1-.3s-.4.3-1 .3c-1.5 0-3-1.5-3-3.5C8 15 12 12 12 12z" opacity="0.85"/></svg>
                    <svg v-else-if="currentTheme === 'air'" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" width="18" height="18"><path d="M9.59 4.59A2 2 0 1 1 11 8H2m10.59 11.41A2 2 0 1 0 14 16H2m15.73-8.27A2.5 2.5 0 1 1 19.5 12H2"/></svg>
                    <svg v-else-if="currentTheme === 'eternal'" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="18" height="18"><path d="M18.178 8c5.096 0 5.096 8 0 8-5.095 0-7.133-8-12.739-8-4.585 0-4.585 8 0 8 5.606 0 7.644-8 12.74-8z"/></svg>
                    <svg v-else-if="currentTheme === 'amethyst'" viewBox="0 0 24 24" fill="currentColor" width="18" height="18"><path d="M12 2L4 9l8 13 8-13-8-7zm0 3.5L7.5 9.5 12 17l4.5-7.5L12 5.5z"/></svg>
                    <svg v-else-if="currentTheme === 'pearl'" viewBox="0 0 24 24" fill="currentColor" width="18" height="18"><circle cx="12" cy="12" r="8" opacity="0.3"/><circle cx="12" cy="12" r="6"/><circle cx="9.5" cy="9.5" r="2" opacity="0.4" fill="white"/></svg>
                    <svg v-else-if="currentTheme === 'midnight'" viewBox="0 0 24 24" fill="currentColor" width="18" height="18"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>
                    <svg v-else-if="currentTheme === 'love'" viewBox="0 0 24 24" fill="currentColor" width="18" height="18"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg>
                    <svg v-else-if="currentTheme === 'earth'" viewBox="0 0 24 24" fill="currentColor" width="18" height="18"><path d="M12 2C9 2 6.5 4 5.5 7c-1.5.5-2.5 2-2.5 3.5C3 12.5 4.5 14 6 14.5c.5 2 2 3.5 4 4v2.5c0 .6.4 1 1 1h2c.6 0 1-.4 1-1v-2.5c2-.5 3.5-2 4-4 1.5-.5 3-2 3-3.5 0-1.5-1-3-2.5-3.5C17.5 4 15 2 12 2z"/></svg>
                  </span>
