              ...
              <div class="settingsThemeGrid">
                ...
                >
                  ...
                  >
                    ...
                    <svg v-else-if="t.icon === 'earth'" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="20" height="20"><path d="M3 20h18"/><path d="M12 4l-7 16h14L12 4z" fill="currentColor" opacity="0.3"/><path d="M12 4l-7 16h14L12 4z"/><path d="M8 14l2-3 2 2 2-4" opacity="0.6"/></svg>
